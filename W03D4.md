...
You paused CSV output on W03D1 when the data shape changed. Now bring it back, flattened — one row per page, with brand name as a column.
...
`journal/W03D4.md`. Standard structure. Add:
