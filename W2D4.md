# Week 2, Day 4 — Richer Parsing: More Than Just the Title
*v1.0.0*
...
Activate venv. Run `python3 fetch_many.py` once. If it doesn't work, fix it before adding new code. The W1D4 rule still applies: don't pile new code on broken code.
...
`journal/W2D4.md`. Same structure (What I did / What I learned / What I don't fully understand / Claude check-in). Add one extra question:
