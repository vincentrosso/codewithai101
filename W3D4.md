# Week 3, Day 4 — Real CLI: argparse
*v1.0.0*
...
You paused CSV output on W3D1 when the data shape changed. Now bring it back, flattened — one row per page, with brand name as a column.
...
`journal/W3D4.md`. Standard structure. Add:
