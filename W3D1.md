# Week 3, Day 1 — From URL List to Brand Config
*v1.0.0*
...
CSV output is paused for today. We'll restore it in a flatter form on W3D4.
...
`journal/W3D1.md`. Standard structure (What I did / What I learned / What I don't fully understand / Claude check-in). Add:
