...
That's all for today. We'll connect git on your laptop to GitHub on W01D2.
...
In Sublime, create a new file and save it as `~/dev/brand-lens/journal/W01D1.md`. Three sections:
...
- A `W01D1.md` journal entry exists
